...
LLM Bridge is a personal LLM bridge for [**MeshMonitor**](https://github.com/Yeraze/MeshMonitor) that allows users to interact with their chosen Large Language Model (OpenClaw, Ollama, OpenAI, etc.) over [**Meshstatic**](https://meshtastic.org/)
